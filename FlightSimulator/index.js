...
Module['FS_createPath']("/assets", "Ground Textures", true, true);
Module['FS_createPath']("/assets", "Planes", true, true);
Module['FS_createPath']("/assets/Planes", "Aeroplane", true, true);
Module['FS_createPath']("/assets/Planes", "Airplane (1)", true, true);
Module['FS_createPath']("/assets/Planes", "Airplane", true, true);
Module['FS_createPath']("/assets", "Trees", true, true);
Module['FS_createPath']("/assets/Trees", "Orange tree", true, true);
Module['FS_createPath']("/assets/Trees", "Pine tree", true, true);
Module['FS_createPath']("/assets", "cloud", true, true);
Module['FS_createPath']("/assets", "grass", true, true);
Module['FS_createPath']("/assets/grass", "Grass #1", true, true);
Module['FS_createPath']("/assets/grass", "Grass", true, true);
Module['FS_createPath']("/assets/grass", "grass blades", true, true);
Module['FS_createPath']("/assets", "skybox", true, true);
Module['FS_createPath']("/", "shaders", true, true);
Module['FS_createPath']("/shaders", "clouds", true, true);
Module['FS_createPath']("/shaders", "plane", true, true);
Module['FS_createPath']("/shaders", "skybox", true, true);
Module['FS_createPath']("/shaders", "terrain", true, true);
Module['FS_createPath']("/shaders", "trees", true, true);
...
var _change_plane = Module['_change_plane'] = createExportWrapper('change_plane', 1);
var _change_terrain_parameters = Module['_change_terrain_parameters'] = createExportWrapper('change_terrain_parameters', 7);
